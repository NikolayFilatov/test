 ...
 */
class DishGroup extends \Application\Entity\Dish\DishGroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addDish(\Application\Entity\Dish\Dish $dish)
    {
        $this->__load();
